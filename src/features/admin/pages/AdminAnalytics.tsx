...
export default function AdminAnalytics() {
  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <StatCard label="Total Generations" value={data.stats.totalGenerations} change="23% this month" trend="up" icon={Sparkles} />
        <StatCard label="Detection Accuracy" value={data.stats.detectionAccuracy} change="2.1% improvement" trend="up" icon={Target} />
        <StatCard label="Avg. Confidence" value={data.stats.avgConfidence} change="1.8% this week" trend="up" icon={Brain} />
        <StatCard label="Top Style" value={data.stats.topStyle} icon={TrendingUp} />
        <StatCard label="Most Saved" value={data.stats.mostSaved} change="18% this week" trend="up" icon={Heart} />
        <StatCard label="Failed Detections" value={data.stats.failedDetections} change="5% decrease" trend="up" icon={Eye} />
      </div>
