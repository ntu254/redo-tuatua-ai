...
import { Brain, Eye, Heart, Sparkles, Target, TrendingUp } from "lucide-react";
            ...
            {accuracy.map((d) => (
              <div key={d.month}>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-xs font-semibold font-body text-teal">
                    {d.rate}%
                  </span>
                </div>
            ...
            {topPrompts.map((p, i) => (
              <div key={i} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-xs font-semibold text-muted-foreground font-body w-5">
                    {i + 1}
                  </span>
            ...
            {failedDetections.map((f, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-semibold font-body text-destructive">
                    {f.rate}
                  </span>
                </div>
              </div>
