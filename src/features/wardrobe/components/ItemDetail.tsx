    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          style={{ height: "calc(100vh / 0.85)", zoom: "85%" }}
          className="fixed bottom-0 left-0 right-0 top-auto md:top-0 md:right-0 md:left-auto z-50 w-full md:w-[360px] lg:w-[400px] bg-background rounded-t-3xl md:rounded-none shadow-2xl flex flex-col border-l border-border/50 overflow-hidden"
        >
