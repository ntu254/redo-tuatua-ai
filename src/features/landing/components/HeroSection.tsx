        ...
        <div className="grid min-h-[calc(100vh-5rem)] grid-cols-1 items-center gap-8 lg:grid-cols-2">
          <motion.div style={{ y: textY }} className="py-10 lg:py-24 lg:pr-16">
            ...
            >
              ...
              link mua hàng từ Shopee, Lazada, Tiki và nhiều sàn khác.
            </p>
                ...
                {outfitCards.map((card) => (
                  ...
                  >
                    ...
                    <div className="mt-1 flex items-center justify-between">
                      <span className="text-[10px] font-body font-semibold text-accent">
                        {card.price}
                      </span>
            ...
            >
              ...
              >
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-body font-semibold text-foreground">
                      Casual Chic Set
                    </p>
                ...
                <div className="flex gap-1.5">
                  ...
                  <span className="ml-auto text-[9px] font-body font-semibold text-accent">
                    881K
                  </span>
                </div>
              </motion.div>
