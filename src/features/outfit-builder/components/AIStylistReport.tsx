...
export default function AIStylistReport({
  ...
  return (
    <aside className="w-full lg:w-[360px] bg-background/40 backdrop-blur-md lg:border-l border-border/40 flex flex-col py-8 px-6 gap-6 shrink-0 z-10 h-full overflow-hidden">
      {/* Header */}
