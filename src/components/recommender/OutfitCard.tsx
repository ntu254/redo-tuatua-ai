      ...
      <div className="flex">
        ...
        <div className="relative w-[200px] xl:w-[220px] shrink-0">
          ...
          >
            ...
            >
              <Bookmark
                className={`w-4 h-4 transition-colors ${saved ? "text-accent fill-accent" : "text-foreground"}`}
              />
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.1 }}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 mb-0.5">
                    ...
                    <span className={`text-[10px] font-body font-bold ${platformStyles[p.platform]?.text}`}>
                      {p.platform}
                    </span>
                    {p.badge && (
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span className="text-[10px] font-body text-muted-foreground">· {p.sold} sold</span>
                  </div>
                </div>
