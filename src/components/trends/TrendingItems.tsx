...
const items = [
  { name: "Cargo Pants", image: cargoImg, insight: "Searches increased 45% this season.", growth: "+45%" },
  { name: "Oversized Blazer", image: blazerImg, insight: "A must-have for quiet luxury styling.", growth: "+32%" },
  { name: "Chunky Sneakers", image: sneakersImg, insight: "Dominating streetwear and athleisure looks.", growth: "+28%" },
  { name: "Wide-Leg Jeans", image: jeansImg, insight: "The silhouette of the season.", growth: "+38%" },
  { name: "Vintage Hoodie", image: hoodieImg, insight: "Y2K nostalgia drives casual styling.", growth: "+22%" },
  { name: "Statement Heels", image: heelsImg, insight: "Evening wear's top trending item.", growth: "+19%" },
];
    ...
    <section className="py-14 md:py-20 border-t border-border">
      <div className="container mx-auto max-w-6xl px-6">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="editorial-label mb-3">Most Searched Items</p>
            <h2 className="font-heading text-3xl md:text-4xl font-light text-foreground">
              Trending <span className="italic">Items</span>
            </h2>
          </div>
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] font-body text-muted-foreground leading-relaxed line-clamp-2">
                  {item.insight}
                </p>
                <div className="mt-2 flex items-center gap-1 text-[9px] font-body font-medium uppercase tracking-wider text-accent opacity-0 group-hover:opacity-100 transition-opacity">
                  Generate outfit <ArrowRight className="w-2.5 h-2.5" />
                </div>
              </div>
            </motion.button>
          ))}
