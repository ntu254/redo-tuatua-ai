      ...
      <Tabs defaultValue="general" className="w-full">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="font-body text-sm">Enable Style Quiz</Label>
                    <p className="text-xs text-muted-foreground font-body">Show style quiz for new users</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="font-body text-sm">Enable Wardrobe Scan</Label>
                    <p className="text-xs text-muted-foreground font-body">Allow AI wardrobe scanning on signup</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="font-body text-sm">Skip Onboarding Option</Label>
                    <p className="text-xs text-muted-foreground font-body">Let users skip onboarding</p>
                  </div>
                  <Switch />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid gap-4 max-w-md">
                <div className="space-y-2">
                  ...
                  <Input defaultValue="StyleAI" className="font-body text-sm" />
                </div>
                <div className="space-y-2">
                  <Label className="font-body text-sm">Support Email</Label>
                  <Input defaultValue="support@styleai.com" className="font-body text-sm" />
                </div>
              </div>
            </div>
          ...
          <div className="bg-card border border-border rounded-lg p-6 space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Casual", "Streetwear", "Office", "Date Night", "Athleisure", "Party", "Minimal", "Bohemian"].map((s) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Work", "Weekend", "Date", "Party", "Vacation", "Formal Event", "Gym", "School"].map((o) => (
            ...
            <div>
              ...
              <div className="flex gap-3">
                {["#E8927C", "#2EC4B6", "#1D1D1D", "#F4F0EC", "#6C63FF", "#FFD166", "#EF476F", "#118AB2"].map((c) => (
        ...
        <TabsContent value="notifications" className="mt-6">
          <div className="bg-card border border-border rounded-lg p-6 space-y-4">
            ...
            {["Welcome Email", "Weekly Style Report", "New Trend Alert", "Outfit Saved Confirmation", "Account Suspension Notice"].map((t) => (
