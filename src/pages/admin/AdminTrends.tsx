...
const trends = [
  { id: 1, img: "🌸", title: "Spring Pastel Revival", category: "Seasonal", season: "Spring 2026", status: "Published", date: "2026-03-01" },
  { id: 2, img: "🖤", title: "Neo Minimalism", category: "Style", season: "All Year", status: "Published", date: "2026-02-15" },
  { id: 3, img: "🌊", title: "Coastal Grandmother 2.0", category: "Lifestyle", season: "Summer 2026", status: "Draft", date: "2026-03-10" },
  { id: 4, img: "⚡", title: "Tech-Wear Evolution", category: "Street", season: "Fall 2026", status: "Draft", date: "2026-03-08" },
  { id: 5, img: "✨", title: "Quiet Luxury Continues", category: "Premium", season: "All Year", status: "Published", date: "2026-01-20" },
  { id: 6, img: "🎨", title: "Color Blocking Returns", category: "Color", season: "Spring 2026", status: "Published", date: "2026-02-28" },
];
  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="relative w-64">
        ...
        <Input placeholder="Search trends..." className="pl-9 h-9 text-sm font-body" value={search} onChange={(e) => setSearch(e.target.value)} />
      </div>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem>{t.status === "Published" ? <><EyeOff className="h-4 w-4 mr-2" />Unpublish</> : <><Eye className="h-4 w-4 mr-2" />Publish</>}</DropdownMenuItem>
