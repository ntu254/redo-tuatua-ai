      ...
      <div className="flex-1 flex flex-col bg-background">
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <motion.div className="w-full max-w-sm" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            ...
            <h1 className="font-heading text-2xl md:text-3xl font-semibold text-foreground mb-1.5">Tạo tài khoản</h1>
            <p className="text-foreground/50 font-body text-sm mb-6">Bắt đầu hành trình thời trang AI của bạn.</p>
